    ...
    val applications: StateFlow<List<App>> = flow {
        ...
        val extensions = installedPkgs
            .mapNotNull { info ->
                ...
                val isExtension = applicationInfo.metaData?.getString(EXTENSION_MAIN_CLASS) != null ||
                        applicationInfo.metaData?.getString(EXTENSION_FEATURE) != null
                if (!isExtension) return@mapNotNull null
