...
interface ChannelDao {
    ...
    @Query("SELECT * FROM streams WHERE list_name_origin = :listNameOrigin")
    fun observeByListNameOrigin(listNameOrigin: String): Flow<List<Channel>>
    ...
    fun observePlayedRecently(limit: Int): Flow<List<Channel>>
