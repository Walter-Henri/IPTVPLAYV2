...
interface PlaylistRepository {
    ...
    suspend fun onUpdatePlaylistUrl(id: Int, newUrl: String)
    ...
    suspend fun addVirtualStream(title: String, url: String): Int

    suspend fun importChannelsJson(
        retryTimes: Int = 3
    ): Int
    
    suspend fun importChannelsJsonBody(
        body: String
    ): Int
